 ...
 */
package mod.gottsch.forge.villagedungeons.core.util;
...
public class LangUtil {
	...
	/**
	 * this is VillageDungeons's extended methods
	 */
	public static void appendAdvancedHoverText(List<Component> tooltip, Consumer<List<Component>> consumer) {
		LangUtil.appendAdvancedHoverText(VillageDungeons.MOD_ID, tooltip, consumer);
	}
	
    public static String name(String prefix, String suffix) {
    	return name(VillageDungeons.MOD_ID, prefix, suffix);
    }
    ...
    public static String item(String suffix) {
    	return name(VillageDungeons.MOD_ID, "item", suffix);
    }
    
    public static String tooltip(String suffix) {
    	return name(VillageDungeons.MOD_ID, "tooltip", suffix);
    }
    
    public static String screen(String suffix) {
    	return name(VillageDungeons.MOD_ID, "screen", suffix);
    }

	public static String chat(String suffix) {
		return name(VillageDungeons.MOD_ID, "chat", suffix);
	}
}
